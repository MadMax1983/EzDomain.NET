...
namespace EzDomain.EventSourcing.Tests.UnitTests.Domain.Repositories
{
    ...
    public sealed class RepositoryTests
    {
        ...
        [Test]
        public async Task GIVEN_unchanged_aggregate_root_WHEN_attempting_to_save_THEN_does_not_throw_exception()
        {
            // Arrange
            var repository = new TestRepository(_mockFactory.Object, _mockEventStore.Object);
            ...
            // Act
            Func<Task> action = async () => await repository.SaveAsync(aggregateRoot);
